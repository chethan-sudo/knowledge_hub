...
mermaid.initialize({ startOnLoad: false, theme: "dark", themeVariables: { primaryColor: "#4f46e5", primaryBorderColor: "#6366f1", primaryTextColor: "#e4e4e7", lineColor: "#71717a", secondaryColor: "#27272a", tertiaryColor: "#18181b", background: "#18181b", mainBkg: "#27272a", nodeBorder: "#6366f1", clusterBkg: "#1a1a2e", titleColor: "#e4e4e7" }, flowchart: { padding: 30, nodeSpacing: 80, rankSpacing: 90, htmlLabels: true, wrappingWidth: 200, curve: "basis" }, sequence: { actorMargin: 120, messageMargin: 60 } });
      ...
      {!collapsed && (
        <>
          ...
          <nav className="sidebar-nav" ref={navRef} data-testid="sidebar-nav">
            ...
            <button className="sidebar-item" data-testid="sidebar-bookmarks-btn" onClick={() => navigate("/bookmarks")}><Icon name="Bookmark" size={16}/><span>Bookmarks</span>{bookmarkCount > 0 && <span className="sidebar-badge">{bookmarkCount}</span>}</button>
            ...
            {isAdmin && <button className="sidebar-item" data-testid="sidebar-analytics-btn" onClick={() => navigate("/analytics")}><Icon name="BarChart" size={16}/><span>Analytics</span></button>}
